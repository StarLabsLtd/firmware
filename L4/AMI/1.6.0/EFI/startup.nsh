...
echo "Changed default brightness to 100"
echo "Updated Secure Boot Keys"
echo "Improved support for SATA SSD's"
echo "Improved charging speed"
echo "Improved Type-C detection"
