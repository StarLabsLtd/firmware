...
#### ami-flashrom: [25.06](https://support.starlabs.systems/kb/firmware/getting-started) 2025-06-30
>     General Updates:
...
#### ami-flashrom: [25.09](https://support.starlabs.systems/kb/firmware/getting-started) 2025-09-18
>     General Updates:
...
#### ami: [25.09](https://support.starlabs.systems/kb/firmware/getting-started) 2025-09-18
>     General Updates:
>     * Faster power sequencing
>     * Wake up from S3 when the battery is low
>     * Make forced-shutdowns more stable
...
#### ami-flashrom: [25.10](https://support.starlabs.systems/kb/firmware/getting-started) 2025-09-28
>     General Updates:
>     * Faster power sequencing
>     * Wake up from S3 when the battery is low
>     * Make forced-shutdowns more stable
...
#### ami: [25.10](https://support.starlabs.systems/kb/firmware/getting-started) 2025-09-28
>     General Updates:
>     * Faster power sequencing
>     * Wake up from S3 when the battery is low
>     * Make forced-shutdowns more stable
...
#### ami-flashrom: [25.12](https://support.starlabs.systems/kb/firmware/getting-started) 2025-12-17
>     General Updates:
>     * EC startup time has been reduced from 415ms to 170ms, whilst being hardened to avoid getting stuck
...
#### ami: [25.12](https://support.starlabs.systems/kb/firmware/getting-started) 2025-12-17
>     General Updates:
>     * EC startup time has been reduced from 415ms to 170ms, whilst being hardened to avoid getting stuck
>     * Remove the power button debounce (double press is no longer required)
>     * The system will now wake if suspended, and the battery gets too low
