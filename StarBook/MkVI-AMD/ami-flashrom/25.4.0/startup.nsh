...
echo "* Update AGESA to the latest version"
echo "* Make the VRAM allocation configurable"
echo "* Fix issue that prevented the batteries from charging"
echo ""
echo ""
