...
#### coreboot: [25.10](https://support.starlabs.systems/kb/firmware/getting-started) 2025-10-16
>     General Updates:
...
#### coreboot: [26.01](https://support.starlabs.systems/kb/firmware/getting-started) 2026-02-12
>     General Updates:
>     * Improved sleep/wake and reset reliability
>     * Added support for EFI capsules for easier, more secure updates
>     * Updated BIOS setup lauouy, with simpler user-interface
